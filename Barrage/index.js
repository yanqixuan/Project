let data = [
    {value:'我不 我就要听爸爸的话',time:5,color:'red',speed:1,fontSize:22},
    {value:'一只酱好帅',time:7,color:'red',speed:1,fontSize:22},
    {value:'听妈妈的话吧 晚点再恋爱吧',time:9,color:'red',speed:1,fontSize:22},
    {value:'前方高能',time:11,color:'red',speed:1,fontSize:22},
    {value:'阿伟死了',time:13,color:'red',speed:1,fontSize:22},
    {value:'FFFFFFFFF',time:15,color:'red',speed:1,fontSize:22},
    {value:'真好听欸',time:17,color:'red',speed:1,fontSize:22}
]
